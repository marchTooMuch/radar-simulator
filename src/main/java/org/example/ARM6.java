...
public class ARM6 extends AntiRadiationMissile {// ARM3 is related to the first grafic{
    int i = 0;
    ARM6(double x, double y, ImageView view1, ImageView view2, int height, double azimuth) {
...
//        }
        ...
        if(distanceInKm.getValue() < 12) {
            System.out.println("----hello from arm6-------------------------------------------------------------------");
...
//        y = sector.getCenterY() - sector.getRadiusY() * fraction * Math.sin(Math.toRadians(angle));
    ...
    public static AntiRadiationMissile spawnMissileARM1(Pane missileLayer, Arc sector) {
        ...
        ARM6 m = new ARM6(x, y, view, view2,8000, angle);
//        m.angle = angle;
