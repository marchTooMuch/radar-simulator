...
public class ARM5 extends AntiRadiationMissile {// ARM3 is related to the first grafic{
    int i = 0;
    ARM5(double x, double y, ImageView view1, ImageView view2, int height, double azimuth) {
        super(x,y,view1,view2,height, azimuth);
        speed = 100;
        speedKmPerSecond.setValue(2000);
        targetCrossSection.setValue(1.2);
...
//        y = sector.getCenterY() - sector.getRadiusY() * fraction * Math.sin(Math.toRadians(angle));
    ...
    public static AntiRadiationMissile spawnMissileARM1(Pane missileLayer, Arc sector) {
        ...
        ARM5 m = new ARM5(x, y, view, view2,8000, angle);
//        m.angle = angle;
